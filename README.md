...
電子署名は、デジタルデータの真正性と完全性を保証するための技術です。送信者が自身の秘密鍵を用いてデータに署名を行い、受信者が送信者の公開鍵を用いて署名を検証することで、データの改ざんや送信者のなりすましを防ぐことができます。

ここで、改ざんとなりすましについて、具体的な例を挙げて説明します。

改ざんの例：
AさんがBさんに重要な契約書をメールで送信したとします。しかし、途中で第三者が契約書の内容を不正に書き換えてしまったとします。このような改ざんを防ぐために、Aさんは契約書に自身の秘密鍵で電子署名を付与します。Bさんは受信した契約書の電子署名をAさんの公開鍵で検証することで、契約書が改ざんされていないことを確認できます。

なりすましの例：
AさんになりすましたCさんが、Bさんに偽の請求書をメールで送信したとします。Bさんは、請求書がAさんから送られてきたものだと信じて、代金を支払ってしまうかもしれません。このようななりすましを防ぐために、Aさんは請求書に自身の秘密鍵で電子署名を付与します。Bさんは受信した請求書の電子署名をAさんの公開鍵で検証することで、請求書が本当にAさんから送られてきたものであることを確認できます。

このように、電子署名は送信者の秘密鍵による署名と送信者の公開鍵を用いることで、デジタルデータの改ざんとなりすましを防ぐことができます。電子署名は、法的にも手書き署名と同等の効力を持つとされており、オンラインでの契約や取引において重要な役割を果たしています。
...
デジタルアイデンティティ基盤では、本人が自身の情報をコントロールできます。オンラインで個人情報を提示する際、どの情報を開示するかを本人が選択できるため、プライバシーが保護されます。例えば、年齢確認の場合は生年月日のみを開示し、住所は非開示にできます。このように、目的に応じて必要最小限の情報のみを提示できます。
